...
//
// ASCOM Camera driver for MallincamUniverse_I
//
// Description:	 A basic driver stripped of binning and preview window features
//
// Implements:	ASCOM Camera interface version: 0.0.0
...
{
    //
    // This code is mostly a presentation layer for the functionality in the CameraHardware class.
    // You should not need to change the contents of this file very much, if at all.
    // Most customisation will be in the CameraHardware class, which is shared by all
    // instances of the driver, and which must handle all aspects of communicating with your device.
    //
    // Your driver's DeviceID is ASCOM.MallincamUniverse_I.Camera
    //
    // The COM Guid attribute sets the CLSID for ASCOM.MallincamUniverse_I.Camera
    // The COM ClassInterface/None attribute prevents an empty interface called _MallincamUniverse_I
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("b1f24ab5-a2c5-4228-b9c5-399d87556dae")]
    [ProgId("ASCOM.MallincamUniverse_I.Camera")]
    [ServedClassName("ASCOM Camera Driver for MallincamUniverse_I")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Camera : ReferenceCountedObjectBase, ICameraV3, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MallincamUniverse_I"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Camera()
        {
            try
            {
                ...
                tl = new TraceLogger("", "MallincamUniverse_I.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
